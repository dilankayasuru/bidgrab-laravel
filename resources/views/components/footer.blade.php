<footer class="bg-blue bg-opacity-5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-16 border-b border-zinc-400 flex justify-between items-center">
            <div>
                <a href="{{ url('/') }}" class="text-3xl font-bold text-blue mb-8 flex">BidGrab</a>
    ...
    <div class="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p class="text-sm text-zinc-500">© 2024 BidGrab, All rights reserved.</p>
    </div>

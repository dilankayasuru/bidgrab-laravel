...
$dosomething = fn() => ($this->keyword = 'clicked');

?>

<div class="w-full px-4 bg-white rounded-full shadow-sm flex justify-between max-w-md border-zinc-200 border">
    <input type="text" placeholder="Search Products" id="search" class="w-full border-none appearance-none outline-none !ring-offset-0 !ring-0 !shadow-none">
    <button wire:click="dosomething">
